 ...
 * Author: Arlin Alzate
 *
 * Created on February 1, 2024, 11:10 AM
...
int main(int argc, char** argv) {
    ...
    do {
        ...
        {
            cout << endl << endl << "The pot has less than or equal to two but more than 0 chips, " << endl << " to continue playing, " << endl
                 << setw(10) <<"Everyone add TWO to the pot!" << endl;
            chp1 -= 2;
            chp2 -=2;
            pot += 4;
            cout << "Every player put two chips that brings: " << endl
